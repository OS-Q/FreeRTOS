...
//	s_tBtn[0].IsKeyDownFunc = IsKeyDown2;
	s_tBtn[1].IsKeyDownFunc = IsKeyDown3;
	s_tBtn[2].IsKeyDownFunc = IsKeyDown4;
	s_tBtn[3].IsKeyDownFunc = IsKeyDown5;
	s_tBtn[4].IsKeyDownFunc = IsKeyDown6;
	s_tBtn[5].IsKeyDownFunc = IsKeyDown7;
	s_tBtn[6].IsKeyDownFunc = IsKeyDown8;

	/* 组合键 */
//	s_tBtn[7].IsKeyDownFunc = IsKeyDown9;
//	s_tBtn[8].IsKeyDownFunc = IsKeyDown10;
}
