...
*	文件名称 : main.c
*	版    本 : V1.0
*	说    明 : 本实验主要学习FreeRTOS的任务延迟，优先级，挂起和恢复设置
*              实验目的：
*                1. 学习FreeRTOS的任务延迟，优先级，挂起和恢复设置。
*              实验内容：
...
*                 5. K2按键按下，获取任务vTaskLED的优先级。
*                 6. k3按键按下，重新设置任务vTaskLED优先级。
*                 7. 摇杆UP按键按下，挂起任务vTaskLED。
*                 8. 摇杆DOWN键按下，恢复任务vTaskLED。
*              注意事项：
